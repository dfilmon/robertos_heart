    ...
    <div>
      <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        <a class="text-3xl font-bold leading-none" href="#">
          <img
            src="https://i.imgur.com/6IuzDyf.pnghttps://cdn.jsdelivr.net/gh/dfilmon/rudisha@main/src/img/logo.png"
            width="50px"
          />
        </a>
        <div class="lg:hidden">
          <button class="navbar-burger flex items-center brandColorText p-3">
            <svg
        ...
        <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div>
            <ul>
              <li class="mb-1">
                <a
                  class="block p-4 text-sm font-semibold text-gray-400 hover:bg-yellow-500 hover:brandColorText rounded"
                  href="#"
                >
                  Home
                </a>
