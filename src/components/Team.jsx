          ...
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group brandColor hover:brandColor dark:border-gray-700 dark:hover:border-transparent">
              ...
              <div class="flex mt-3 -mx-2">
                <a
                  href="#"
                  class="mx-2 text-white dark:text-white hover:text-white dark:hover:text-white group-hover:text-white"
                  aria-label="Reddit"
                >
                  <svg
                ...
                <a
                  href="#"
                  class="mx-2 text-white dark:white hover:white dark:hover:white group-hover:text-white"
                  aria-label="Facebook"
                >
                  <svg
                    class="w-6 h-6 fill-current"
